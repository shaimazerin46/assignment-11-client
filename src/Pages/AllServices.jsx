...
const AllServices = () => {
    ...
    return (
        <div>
            ...
            <h3 className="text-center text-3xl font-bold md:py-20 py-5">All of our services {services.length}</h3>
            <div className="px-3 md:px-3 lg:px-0 grid md:grid-cols-2 lg:grid-cols-3 gap-5 md:mb-20 mb-5">
                {
